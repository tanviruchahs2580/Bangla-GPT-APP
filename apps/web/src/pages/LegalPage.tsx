const SECTIONS: { titleBn: string; titleEn: string; bodyBn: string; bodyEn: string }[] = [
  {
...
export default function LegalPage({ kind }: { kind: 'privacy' | 'terms' }) {
  ...
  return (
    <div className="card" style={{ maxWidth: 780, margin: '40px auto' }}>
      <h2>{isPrivacy ? 'গোপনীয়তা নীতি / Privacy Policy' : 'ব্যবহারের শর্তাবলি / Terms of Service'}</h2>
      {isPrivacy ? (
        <>
        ...
        <>
          <section>
            <h3>১. সেবার ধরন</h3>
            <p>
              এটি একটি NCTB পাঠ্যবই-ভিত্তিক শিক্ষা সহায়ক। উত্তরগুলো সরবরাহকৃত পাঠ্যবইয়ের অংশ
              থেকে দেওয়া হয়; পরীক্ষার একমাত্র উৎস হিসেবে এটিকে ভরসা করবেন না।
            </p>
            <p className="muted">
              This is an NCTB-textbook-grounded study aid. Answers come from supplied textbook
              passages; do not rely on it as the sole source of truth.
            </p>
          </section>
          <section>
            <h3>২. অ্যাকাউন্ট দায়িত্ব</h3>
            <p>
              পাসওয়ার্ড গোপন রাখা ব্যবহারকারীর দায়িত্ব। অন্যের অ্যাকাউন্টে অনুপ্রবেশ বা
              সেবার অপব্যবহার নিষিদ্ধ।
            </p>
            <p className="muted">
              Keep your password confidential. Impersonation or abuse of the service is prohibited.
            </p>
          </section>
          <section>
            <h3>৩. বৌদ্ধিক সম্পত্তি</h3>
            <p>পাঠ্যবইয়ের বিষয়বস্তুর স্বত্ব NCTB/সংশ্লিষ্ট মালিকদের; শেখার উদ্দেশ্যেই ব্যবহৃত হয়।</p>
            <p className="muted">
              Textbook content remains the property of NCTB/rights holders and is used for study
              purposes only.
            </p>
          </section>
          <p className="muted">সংশোধনী তারিখ: ২০২৬-০৮-২৬</p>
