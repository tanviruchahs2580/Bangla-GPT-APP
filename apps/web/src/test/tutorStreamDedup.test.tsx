...
const CONV = { id: 9, title: 'Chat', created_at: '2026-09-08T00:00:00Z', message_count: 0 }
    ...
    apiMock.postStream.mockImplementation(
      async (_path: string, _body: unknown, onToken: (tok: string) => void) => {
        ...
        return {
          ...
          grounded: true,
          refused_reason: null,
          sources: [{ book: 'Science 6', chapter: 'Kosh', section: 'Kosh ki', page: 12, score: 0.9, excerpt: 'Kosh ki?' }],
        }
      },
    )
  })
