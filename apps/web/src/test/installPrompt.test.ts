...
import { canInstall, initInstallPrompt, installed, promptInstall } from '../lib/installPrompt'
...
function fireBeforeInstall(outcome: 'accepted' | 'dismissed' = 'accepted'): Promptable {
  const evt = new Event('beforeinstallprompt', { cancelable: true }) as Promptable
