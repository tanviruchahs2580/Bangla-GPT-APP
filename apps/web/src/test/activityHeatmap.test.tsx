...
describe('S1.9 streak heatmap UI', () => {
  beforeEach(() => {
    ...
    apiMock.get.mockImplementation((path: string) => {
      if (path.startsWith('/students/7/activity')) return Promise.resolve(summary())
  ...
  it('renders one heat cell per day, the streak label and activity levels', async () => {
    ...
    expect(await screen.findByText(t('streakLabel', { days: 3 }))).toBeInTheDocument()
    ...
    expect(hot.getAttribute('title')).toContain(t('activityQuestions', { n: 6 }))
